// Planning types extracted from modules/planning/types.ts
// TODO: Refactor - consolidate with other type definitions, consider using Zod schemas
...
export interface PlanningProjectObject {
  id: string
  name: string
  description?: string
  stageId?: string | null
