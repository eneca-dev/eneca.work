-- ============================================================================
-- Migration: Add actual hours from work_logs to v_resource_graph
-- Date: 2025-12-20
-- Description: Adds decomposition_item_actual_hours column by aggregating
--              work_logs data for each decomposition_item
-- ============================================================================

-- ============================================================================
-- ROLLBACK VERSION (for reference)
-- To rollback, run this in a new migration file:
-- ============================================================================
/*
...
CREATE VIEW public.v_resource_graph AS
 SELECT p.project_id,
    ...
    sec.section_description,
    -- ========================================================================
    -- NEW: Actual hours from work_logs aggregated by decomposition_item_id
    -- ========================================================================
   ...
   FROM projects p
     ...
     LEFT JOIN work_categories wc ON wc.work_category_id = di.decomposition_item_work_category_id
     -- ========================================================================
     -- NEW JOIN: Aggregate work_logs hours by decomposition_item_id
     -- ========================================================================
     LEFT JOIN LATERAL (
       SELECT
...
--   decomposition_item_actual_hours,
