-- ============================================================================
-- ROLLBACK Migration: Remove CPI from v_resource_graph
-- Date: 2025-12-20
-- Description: Reverts v_resource_graph to version WITH actual_hours but WITHOUT CPI
-- Usage: Apply this migration if you need to rollback CPI changes
-- ============================================================================
