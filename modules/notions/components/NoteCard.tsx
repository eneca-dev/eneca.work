                      ...
                      >
                        <div
                          className="prose prose-sm max-w-none dark:prose-invert pointer-events-none
                                   [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:my-2 [&_ul]:text-gray-900 dark:[&_ul]:text-gray-100 [&_ul_::marker]:text-gray-900 dark:[&_ul_::marker]:text-gray-100
                                   [&_ol]:list-decimal [&_ol]:ml-6 [&_ol]:my-2 [&_ol]:text-gray-900 dark:[&_ol]:text-gray-100 [&_ol_::marker]:text-gray-900 dark:[&_ol_::marker]:text-gray-100
                                   ...
                                   [&_blockquote]:border-l-4 [&_blockquote]:border-gray-300 dark:[&_blockquote]:border-gray-600 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-gray-700 dark:[&_blockquote]:text-gray-300 [&_blockquote_::before]:content-none
                                   [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:mb-4 [&_h1]:mt-6 [&_h1]:text-gray-900 dark:[&_h1]:text-gray-100
                                   [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mb-3 [&_h2]:mt-5 [&_h2]:text-gray-900 dark:[&_h2]:text-gray-100
                                   [&_h3]:text-lg [&_h3]:font-bold [&_h3]:mb-2 [&_h3]:mt-4 [&_h3]:text-gray-900 dark:[&_h3]:text-gray-100
                                   ...
                                   [&_table]:border-collapse [&_table]:table [&_table]:max-w-full [&_table]:min-w-[200px] [&_table]:border [&_table]:border-gray-300 dark:[&_table]:border-gray-600 [&_table]:relative [&_table]:my-4 [&_table]:table-auto [&_table]:w-auto
                                   [&_td]:border [&_td]:border-gray-300 dark:[&_td]:border-gray-600 [&_td]:p-2 [&_td]:min-w-0 [&_td]:relative [&_td]:transition-all [&_td]:duration-200 [&_td]:bg-white dark:[&_td]:bg-gray-800 [&_td]:text-gray-900 dark:[&_td]:text-gray-100 [&_td]:whitespace-nowrap [&_td]:overflow-hidden [&_td]:text-ellipsis
                                   [&_th]:border [&_th]:border-gray-300 dark:[&_th]:border-gray-600 [&_th]:p-2 [&_th]:bg-gray-50 dark:[&_th]:bg-gray-700 [&_th]:font-semibold [&_th]:min-w-0 [&_th]:relative [&_th]:transition-all [&_th]:duration-200 [&_th]:text-gray-900 dark:[&_th]:text-gray-100 [&_th]:whitespace-nowrap [&_th]:overflow-hidden [&_th]:text-ellipsis
                                   [&_table_tr:first-child_td]:bg-white dark:[&_table_tr:first-child_td]:bg-gray-800 [&_table_tr:first-child_td]:font-normal [&_table_tr:first-child_td]:text-left [&_table_tr:first-child_td]:text-gray-900 dark:[&_table_tr:first-child_td]:text-gray-100
                                   ...
                                   [&_table_tr:not(:first-child)_th]:bg-gray-50 dark:[&_table_tr:not(:first-child)_th]:bg-gray-700 [&_table_tr:not(:first-child)_th]:font-normal [&_table_tr:not(:first-child)_th]:text-left [&_table_tr:not(:first-child)_th]:text-gray-900 dark:[&_table_tr:not(:first-child)_th]:text-gray-100
                                   [&_table_tr:not(:first-child)_td]:bg-white dark:[&_table_tr:not(:first-child)_td]:bg-gray-800 [&_table_tr:not(:first-child)_td]:font-normal [&_table_tr:not(:first-child)_td]:text-left [&_table_tr:not(:first-child)_td]:text-gray-900 dark:[&_table_tr:not(:first-child)_td]:text-gray-100
