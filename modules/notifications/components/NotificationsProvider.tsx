    ...
    try {
      ...
      switch (entityType) {
        ...
        case 'section_comment':
          console.log('💬 Получено уведомление о комментарии к разделу')
          // Комментарии обновляются локально при получении уведомления
          // Дополнительное обновление модуля не требуется
          break
